...
import {
  ...
  uploadImage, // ⬅️ NEW: single "image" field, 20MB limit
  uploadCertification, // ⬅️ NEW: single "document" field, 10MB limit
...
// Portfolio — image upload (field name: "image", max 20MB)
router.post("/portfolio", ...W, uploadImage, addPortfolio);
router.delete(
  "/portfolio/:id",
  ...W,
  ...validateUUIDParam("id"),
...
// Certifications — document upload (field name: "document", max 10MB)
router.post("/certifications", ...W, uploadCertification, addCertification);

// NEW: Delete a certification (must be the caller's own)
router.delete(
  "/certifications/:id",
  ...W,
  ...validateUUIDParam("id"),
...
// Video intro — video upload (field name: "file", max 100MB)
router.post("/video-intro", ...W, uploadVideo, addVideoIntro);
