...
// src/utils/validators.js
// ─────────────────────────────────────────────────────────────────────────────
// APPEND TO THE BOTTOM OF THE FILE - Survey Validators
// ─────────────────────────────────────────────────────────────────────────────

// ─── §34  SURVEY VALIDATORS ──────────────────────────────────────────────────
...
const VALID_SURVEY_STATUSES = ["PENDING", "REVIEWED", "CONTACTED", "ARCHIVED"];
...
export const validateGetAllSurveyResponses = [
  ...
  query("status")
    .optional()
    .trim()
    .isIn(VALID_SURVEY_STATUSES)
    .withMessage(`Status must be one of: ${VALID_SURVEY_STATUSES.join(", ")}`),
