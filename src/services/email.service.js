...
export async function sendFeedbackAutoReplyEmail({
  ...
  const typeMessages = {
    praise:
      "Thank you for your kind words! They mean the world to us and keep our team motivated. We're thrilled that you're enjoying SkilledProz.",
    suggestion:
      "Thank you for your thoughtful suggestion! We review all feedback carefully and your idea will be considered for future updates. We'll reach out if we need more details.",
    bug: "Thank you for reporting this issue. Our engineering team has been notified and will investigate as soon as possible. We'll keep you updated on the progress.",
    feature:
      "We love hearing feature ideas! Your request has been added to our product roadmap for evaluation. We'll let you know if we need more information.",
    general:
      "Thank you for taking the time to share your thoughts with us. Every piece of feedback helps us build a better platform.",
  };

  const emoji = typeEmojis[feedbackType] || "💬";
  const message = typeMessages[feedbackType] || typeMessages.general;

  const html = baseTemplate({
    title: "We received your feedback — SkilledProz",
    preheader: `Thank you for your feedback about "${feedbackTitle}"`,
    body: `
      <p class="greeting">Hi ${name || "there"}! 👋</p>
      <p>Thank you for taking the time to share your feedback with us. We truly appreciate it!</p>
      
      <div style="text-align:center;padding:20px 0;">
        <span style="font-size:48px;">${emoji}</span>
        <p style="font-size:14px;color:#888;margin-top:8px;">
          <strong style="color:#0F0F6E;">"${feedbackTitle}"</strong>
        </p>
      </div>
      ...
      <div style="background:#f8f8ff;border-radius:8px;padding:16px 20px;margin:20px 0;border:1px solid #e0e0f0;">
        <p style="font-size:13px;color:#555;margin:0;display:flex;align-items:center;gap:8px;">
          <span style="font-size:18px;">⏰</span>
          <span>Our team typically responds within <strong>24–48 hours</strong>. You'll hear from us soon!</span>
        </p>
      </div>
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin:16px 0;">
        <div style="background:#f0fdf4;border-radius:8px;padding:12px 16px;text-align:center;border:1px solid #bbf7d0;">
          ...
          <p style="font-size:12px;color:#16a34a;font-weight:600;margin:4px 0 0;">Feedback Reviewed</p>
        </div>
        <div style="background:#fffbeb;border-radius:8px;padding:12px 16px;text-align:center;border:1px solid #fde68a;">
          <span style="font-size:20px;">🔍</span>
          <p style="font-size:12px;color:#d97706;font-weight:600;margin:4px 0 0;">Team Investigation</p>
        </div>
        <div style="background:#eff6ff;border-radius:8px;padding:12px 16px;text-align:center;border:1px solid #bfdbfe;">
          <span style="font-size:20px;">💬</span>
          <p style="font-size:12px;color:#2563eb;font-weight:600;margin:4px 0 0;">Response Within 48h</p>
        </div>
        <div style="background:#f5f3ff;border-radius:8px;padding:12px 16px;text-align:center;border:1px solid #ddd6fe;">
          <span style="font-size:20px;">✨</span>
          <p style="font-size:12px;color:#7c3aed;font-weight:600;margin:4px 0 0;">Platform Improvement</p>
        </div>
      </div>

      <div class="warning" style="background:#fffbeb;border-left-color:#F59E0B;margin:16px 0;">
        💡 <strong>Did you know?</strong> Your feedback directly influences our product decisions. 
        We read every single submission and use them to make SkilledProz better for everyone.
      </div>

      <p style="font-size:13px;color:#888;text-align:center;margin-top:16px;">
        If you have additional details to share, just reply to this email — we'd love to hear more!
      </p>
  ...
  return sendEmail({
    to,
    subject: `🙏 We received your feedback — "${feedbackTitle}"`,
    html,
  });
}
